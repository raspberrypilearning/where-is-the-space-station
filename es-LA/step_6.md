...
+ Lo que quieres es ser capaz de enviar la tortuga a una determinada latitud y longitud. To make this easy, you can set the screen to match the coordinates you're using and add in the map image:
